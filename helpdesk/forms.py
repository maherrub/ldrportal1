...
class UserTicketForm(forms.ModelForm):
    ...
    assigned_admin = forms.CharField(widget = forms.HiddenInput(), required = False)
...
class TicketResolutionAdminForm(forms.ModelForm):

    class Meta:
        model = TicketResolution

        fields = [
            'resolution_admin_ticket',
            'resolution_admin_fg',
            'resolution_admin_reply',
